...
module('Integration | Component | dummy box', function(hooks) {
  ...
  test('it renders', async function(assert) {
    ...
    await percySnapshot('dummy box test on small width only', { widths: [375] });
  });
  ...
  test('it snapshots radio button values', async function(assert) {
    ...
    await percySnapshot('radio selected');
  });
  ...
  test('it snapshots textarea values', async function(assert) {
    ...
    await percySnapshot('textarea with value');
  });
  ...
  test('it snapshots select values', async function(assert) {
    ...
    await await percySnapshot('select without value');
    await fillIn('select', 'two');
    await await percySnapshot('select with value');
  ...
  test('it handles identical assets with different paths', async function(assert) {
    await render(hbs`
      {{#dummy-box}}
        ...
        <img src="/images/identical-image-1.png">
        <img src="/images/identical-image-2.png">
      {{/dummy-box}}
    `);
